...
public class AuctionManager {
	...
	private static HashMap<String, Auction> auctions = new HashMap<String, Auction>();	
		
	public static Auction createAuction(String name, User auctionAdmin) {
